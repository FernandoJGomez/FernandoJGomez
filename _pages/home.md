...
An interesting carbonate and mixed sedimentary system of Cretaceous age is preserved in Salta and Jujuy provinces, in Northwester Argentina. This site is interesting for several reasons, 1) it is still debated if these deposits are lacustrine, marine maerginal or completely marine and thus they may represent important fluctuations in sea-level recorded inland after Pangea break-up. 2) These deposits have an interesting record of diverse (meter-scale) microbialites (stromatolites) as well as a diversity suite of calcarenites with beatifully preserved oolids that allow studing the different environmental settings for ooids creation and their diagenetic transformations. 3) The Yacoraite Formation record the K-T boundary which is still cryptic in this area. 4) The Yacoiraite Formation has been used an exposed analogue for the unusual carbonates that host the world-class oil reserves known as the the Pre-Salt, located in the off-shore basins of Brazil and the Africa coast. **Ariadna Coppa Vigliocco** is a grad student currently working on stratigraphic correlation and environmental intepretation of these interesting unit.
